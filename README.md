...
```diff
+ iOS/Swift developer (MediaFinder, animations, MVC)
+ Hands-on experience with Claude and OpenAI APIs
+ Now: focused on LLM prompt engineering and AI product building
+ Based in Australia
```
...
│
├── week-01/
│   ├── notes.md        ← What I studied, what I built, key insights
│   ├── prompts/        ← Prompt files from each exercise
│   └── scripts/        ← Any Python/JS code written that week
│
├── week-02/ ... week-12/
│
├── projects/
│   ├── project-01/     ← Each project has its own folder + README
│   ├── project-02/
│   └── project-03-capstone/
│
└── resources.md        ← Links, tools, and articles I've found useful
```
...
> [!NOTE]
> **Week 1 — Key concepts locked in:**
> - A prompt is a **specification**, not a question — clarity removes the model's guesswork
> - **Role + Task + Format** is the foundation of every well-structured prompt
> - **Tokens** are the unit of input/output — knowing limits shapes how you design prompts
...
[![GitHub](https://img.shields.io/badge/GitHub-Profile-black)](https://github.com/Khaled-Elsayed-Mohamed)

---

*Updated weekly. Every commit is a day of work.*
