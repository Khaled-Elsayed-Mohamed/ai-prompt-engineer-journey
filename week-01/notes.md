...
| Wed — Day 3 | 📖 Learn | Tokens, Temperature & Context Windows | ⬜ Upcoming |
...
> [!NOTE]
> **Sources to use:** Anthropic docs or OpenAI docs — search "tokens" and "temperature"
...
> [!TIP]
> *(Add your own tip or insight here after studying)*
